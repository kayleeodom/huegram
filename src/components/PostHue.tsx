...
const PostHue = (props:Props) => {
  ...
  return (
    <div className='flex flex-row p-4 justify-evenly gap-8 border-dashed border-4'>

        <div className='flex flex-col w-full p-4 gap-4 border-4 justify-evenly' style={{backgroundColor: color}}>
