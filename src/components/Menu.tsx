      ...
      <div className='w-full bg-white border-b-4 border-pink-500'>
        <div className='flex flex-row justify-evenly p-4 text-center'>
          ...
          <div className="flex items-center">
            <input type="search" id="search-input" onChange={handleSearchChange} className='border-4 text-slate-800 border-slate-800 rounded-full px-8 py-4' value={searchText} />
          </div>
        </div>
      </div>
    </div>
